...
def init_parser():
    ...
    parser.add_argument('--label', type=int, default=121, choices=range(120, 123), help='data label -> 120:ntu18, 121:painting, 122:interview')
...
# generate skeleton files: python main.py  -c 5116 -gs -vp videos/painting_dataset --label 121     ## 120:ntu18, 121:painting, 122:interview ##
